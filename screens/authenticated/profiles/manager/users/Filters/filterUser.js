...
function Filter_Teacher() {
    ...
    const [filteredDataSource, set_filteredDataSource] = useState(Dummydata);
    const [Master_DataSource, setMaster_DataSource] = useState(Dummydata);
    ...
    const searchFilterFunction_Fname_Lname = (text) => {
        ...
        if (text) {
            ...
            const Data = Master_DataSource.filter(function(item) {
            ...
            set_filteredDataSource(Data);

            setsearch_Fname_Lname(Data);
        } else {
            // Inserted text is blank
            // Update FilteredDataSource with masterDataSource
            set_filteredDataSource(Master_DataSource);
    ...
    return ( <
        View style = { styles.studentview_total } > { conditional_searchbar() } <
        ScrollView style = { styles.chipcontainer }
        horizontal = { true }
        showsHorizontalScrollIndicator = { false } >
        <
        Chip style = { styles.chipfilter }
        icon = "filter-outline"
        onPress = { N_Code_func } >
        کد ملی <
        /Chip> <
        ...
        فامیل <
        /Chip> <
        Chip style = { base_today ? styles.chipfilter_enable : styles.chipfilter }
        icon = "filter-outline"
        ...
        امروز <
        /Chip> <
        Chip style = { base_week ? styles.chipfilter_enable : styles.chipfilter }
        icon = "filter-outline"
        onPress = { filter_baseon_week } >
        هفته <
        /Chip> <
        Chip style = { base_month ? styles.chipfilter_enable : styles.chipfilter }
        icon = "filter-outline"
        onPress = {
            filter_baseon_month
        } >
        ماه <
        /Chip> <
        Chip style = { base_year ? styles.chipfilter_enable : styles.chipfilter }
        icon = "filter-outline"
