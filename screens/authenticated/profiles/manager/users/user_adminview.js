// function user_Adminview(){

// }
// export default user_Adminview;
...
import UserActionButton from "./main_actionbuttom/Student_Actionbutton";
...
import Filter_Student from "./Filters/fitter_student";
import Add_User from "./add_user/add_user";
import User_Topnavigation from "./topnavigation/user_topnavigation";


const User_Adminview = ({ Press }) => {
    ...
    return ( <
        >
        <
        Filter_Student SEARCH_FILTER_FUNCTION_Fname_Lname = { searchFilterFunction_Fname_Lname }
        ...
        //     <TouchableOpacity style={{ top: "90%", zIndex: 1, height: 60, alignItems: "flex-start", left: 20 }} onPress={() => { setaddstudentmodal(!addstudentmodal) }} ><Ionicons name="add-circle" size={60} color="#E55400" />
        //       {<Add_User PRESS={() => { setaddstudentmodal(!addstudentmodal) }} MODALSTATE={addstudentmodal} />}
        //     </TouchableOpacity>
