...
function Filter_Teacher_detail() {
    ...
    const [filteredDataSource, setFilteredDataSource] = useState(Dummydata);
    ...
    filter_absence_context.filter_abcent = filteredDataSource;

    useEffect(() => {



        //  console.log(filter_absence_context.filter_abcent)
...
export default Filter_Teacher_detail;
