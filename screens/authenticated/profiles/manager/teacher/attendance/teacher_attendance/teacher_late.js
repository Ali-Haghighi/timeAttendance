...
function Teacher_late() {
    ...
    const tch_Late_filter_context = useContext(Filtercontex);
    const flatlist_filter = tch_Late_filter_context.filter_late;
        ...
        renderItem = {
            ({ item }) => {
                return ( <
                    ...
                    View > <
                    /View> <
                    View style = { styles.threedot_container } > { /* <View style={styles.threedot} onPress={console.log("salam")}></View> */ } { /* <TeacherActionButton ID={item.name} /> */ } <
                    /View> < /
                    View > <
