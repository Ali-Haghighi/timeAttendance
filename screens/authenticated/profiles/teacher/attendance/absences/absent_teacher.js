...
import TeacherActionButton from "../teacher_actionbuttom/teacher_Actionbutton";
...
const Teacher_abcence = ({ Press }) => {
    ...
    return ( <
        ...
        TouchableOpacity style = {
            { top: "90%", zIndex: 1, height: 60, alignItems: "flex-start", left: 20 }
        }
        onPress = { press } > < Ionicons name = "add-circle"
        size = { 60 }
        color = "#E55400" / > < /TouchableOpacity> <
        View style = { styles.studentview_total } > { /* <Filter_Teacher SEARCH_FILTER_FUNCTION_Fname_Lname={searchFilterFunction_Fname_Lname} SEARCH_FILTER_FUNCTION_Ncode={searchFilterFunction_Ncode} SEARCH_Ncode={search_Ncode} SEARCH_fNAME_lNAME={search_Fname_Lname}/> */ }
